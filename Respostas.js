...
//Quiz: Algoritmo
/*
1)	P: Qual é a definição de um algoritmo?
	R: Conjunto de instruções
...
2)	P: Algoritmo é uma sequência de instruções com um objetivo claro. Qual das alternativas abaixo exemplifica um algoritmo?
	R: Junte os ingredientes, mexa tudo até formar uma massa homogênea e asse o bolo até dourar
...
/*
1)	P: Qual tipo de linguagem de programação se assemelha mais à linguagem humana?
...
2)	P: Com base no texto lido anteriormente, escolha a alternativa correta:
	R: No navegador temos a visão de usuário e no editor temos a visão de programador.
...
3)	P: Qual das alternativas abaixo contém somente linguagens de alto nível?
	R: Javascript, PHP, Java
...
/*
1)	P: Por que iremos salvar informações em programação?
	R: Para que possamos reutilizar essas informações, seja para consulta ou para resolver problemas
...
2)	P: Onde iremos salvar informações dentro do nosso código?
	R: Nas variáveis.
	Correção: As variáveis são responsáveis por armazenar as informações.

3)	P: As variáveis têm nome?
	R: Sim
...
//Quiz: Tipos de dados
/*
1)	P: Com base no que aprendemos sobre os tipos de variáveis, e no que você já praticou, selecione a alternativa que CONTÉM ERRO na escrita do código: 
		1 var nome = Hendy Almeida
		2 var Nome = "Hendy Almeida"
		3 var nome = "HeNdY AlMeida"
		4 var variavel = "texto qualquer"
	R: 1 
...
2)	P: Qual tipo de dados utilizamos para guardar uma lista?
		1 Variáveis
		2 Array
		3 String
		4 Boolean
...
//Comissão
/*Crie um sistema para calcular a comissão dos vendedores de uma loja. Crie uma função que tenha dois argumentos: preço e porcentagem de comissão.
>>>>>>> 36f5c962ad0a788a3c829aaa677f1cd33cd30e56
*/